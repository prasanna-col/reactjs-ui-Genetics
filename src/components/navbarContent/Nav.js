      ...
      <div className="header">
        ...
        <Grid className="box">
          <Grid className="boxitems">
            <Grid className={location.pathname === "/Dashboard" ? "dash" : "non_dash"} onClick={navHandle}>
              <p className={location.pathname === "/Dashboard" ? "dash_text"  : "nondash_text"}>Dashboard</p>
            </Grid>
            <Grid className="line" />

            <Grid className={location.pathname === "/ManangeContractors" ? "mc" : "non_mc"} onClick={navHandle1}>
              <p className={location.pathname === "/ManangeContractors" ? "mc_text" : "nonmc_text"}>
                Manage Contractors
              </p>
            </Grid>
            <Grid className="line1" />

            <Grid className={location.pathname === "/ManangeEmployees" ? "me" : "non_me"} onClick={navHandle2}>
              <p className={location.pathname === "/ManangeEmployees" ? "me_text" : "nonme_text"}>
                Manage Employees
              </p>
            </Grid>
            <Grid className="line2" />

            <Grid className={location.pathname === "/ManangeReports" ? "mr" : "non_mr"} onClick={navHandle4}>
              <p className={location.pathname === "/ManangeReports" ? "mr_text" : "nonmr_text"}>
                Manage Reports
              </p>
            </Grid>
            <Grid className="line3" />

            <Grid className={location.pathname === "/ManangeForms" ? "mf" : "non_mf"} onClick={navHandle5}>
              <p className={location.pathname === "/ManangeForms" ? "mf_text" : "nonmf_text"}>Manage Forms</p>
            </Grid>
            <Grid className="line4" />

            <Grid className={location.pathname === "/ManangeLabs"  ? "ml" : "non_ml"} onClick={navHandle6}>
              <p className={location.pathname === "/ManangeLabs" ? "ml_text" : "nonml_text"}>Manage Labs</p>
            </Grid>
            <Grid className="line5" />

            <Grid className={location.pathname === "/Manangephysician" ? "mp" : "non_mp"} onClick={navHandle7}>
              <p className={location.pathname === "/Manangephysician" ? "mp_text" : "nonmp_text"}>
                Manage Physician
              </p>
            </Grid>
